 ...
 */
package com.example.Orderservice.avro;
...
public class OrderCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6474307254623063418L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCreatedEvent\",\"namespace\":\"com.example.Orderservice.avro\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"double\"}]}");
   ...
   */
  public OrderCreatedEvent(java.lang.CharSequence orderId, java.lang.CharSequence product, java.lang.Integer quantity, java.lang.Double price) {
   ...
   */
  public static com.example.Orderservice.avro.OrderCreatedEvent.Builder newBuilder() {
    return new com.example.Orderservice.avro.OrderCreatedEvent.Builder();
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static com.example.Orderservice.avro.OrderCreatedEvent.Builder newBuilder(com.example.Orderservice.avro.OrderCreatedEvent.Builder other) {
    if (other == null) {
      return new com.example.Orderservice.avro.OrderCreatedEvent.Builder();
    } else {
      return new com.example.Orderservice.avro.OrderCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static com.example.Orderservice.avro.OrderCreatedEvent.Builder newBuilder(com.example.Orderservice.avro.OrderCreatedEvent other) {
    if (other == null) {
      return new com.example.Orderservice.avro.OrderCreatedEvent.Builder();
    } else {
      return new com.example.Orderservice.avro.OrderCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.Orderservice.avro.OrderCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.Orderservice.avro.OrderCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Orderservice.avro.OrderCreatedEvent.Builder clearPrice() {
